...
local function CreateMobileGUI()
    ...
    controlPanel.Size = UDim2.new(0, 180, 0, 280) -- 减小尺寸
    controlPanel.Position = UDim2.new(0.5, -90, 0.5, -140) -- 居中显示
    ...
    scrollFrame.Size = UDim2.new(1, 0, 1, -25) -- 留出标题栏空间
    scrollFrame.Position = UDim2.new(0, 0, 0, 25)
    scrollFrame.BackgroundTransparency = 1
    scrollFrame.BorderSizePixel = 0
    scrollFrame.CanvasSize = UDim2.new(0, 0, 0, 400) -- 可滚动内容高度
